  ...
  <div class="learn-view">
    ...
    <div class="indicators-grid">
      <div v-for="ind in indicators" :key="ind.name" class="indicator-card">
        ...
        <div class="section"><span class="badge">怎么用</span><p>{{ ind.usage }}</p></div>
...
.hero {
  background: linear-gradient(135deg, #f0b90b22, transparent);
  border: 1px solid #f0b90b44;
  border-radius: 16px;
  padding: 32px;
  text-align: center;
}
.hero h2 { font-size: 28px; margin-bottom: 8px; color: var(--binance-yellow); }
.hero p { color: var(--binance-text-secondary); }
.indicators-grid {
  display: grid;
...
.ind-header h3 { font-size: 18px; color: var(--binance-yellow); }
.short {
  font-size: 16px;
  font-weight: 600;
  margin-bottom: 8px;
...
.long { font-size: 13px; color: var(--binance-text-secondary); line-height: 1.7; margin-bottom: 16px; }
.section {
  margin-bottom: 12px;
  padding: 10px;
  background: #0b0e11;
...
.concept-card h4 { font-size: 14px; color: var(--binance-yellow); margin-bottom: 8px; }
.concept-card p { font-size: 13px; color: var(--binance-text-secondary); line-height: 1.6; }
.workflow {
  background: var(--binance-card);
  border: 1px solid var(--binance-border);
  border-radius: 12px;
...
.step p { font-size: 11px; color: var(--binance-text-secondary); line-height: 1.5; }
.arrow { display: flex; align-items: center; color: var(--binance-yellow); font-size: 20px; }
.warning-box {
  background: #f6465d11;
...
.warning-box h3 { color: #f6465d; margin-bottom: 12px; font-size: 18px; }
...
.warning-box strong { color: #f6465d; }
